...
<!-- OpenSim Datenbank Einstellungen --> 
    ...
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-text-page" style="font-size:20px"></i><?php echo esc_html__( '  OpenSim Name:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
	...
	<div class="row section">	
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-book" style="font-size:20px"></i><?php echo esc_html__( '  MySQL Server IP:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
	...
	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-book" style="font-size:20px"></i><?php echo esc_html__( '  MySQL Database:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
 	...
 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-book" style="font-size:20px"></i><?php echo esc_html__( '  MySQL User:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
 	...
 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-book" style="font-size:20px"></i><?php echo esc_html__( '  Password:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
...
<!-- // OpenSim Avatar Asset Einstellungen -->
 	...
 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Form:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="66c41e39-38f9-f75a-024e-585989bfab73" name="CONF_os_SHAPE"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Haut:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="77c41e39-38f9-f75a-024e-585989bbabbb" name="CONF_os_SKIN"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Haar:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="d342e6c0-b9d2-11dc-95ff-0800200c9a66" name="CONF_os_HAIR"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Augen:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="4bb6fa4d-1cd2-498a-a84c-95c1a0e745a7" name="CONF_os_EYES"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Hemd:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="00000000-38f9-1111-024e-222222111110" name="CONF_os_SHIRT"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Hose:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="00000000-38f9-1111-024e-222222111120" name="CONF_os_PANTS"/></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Unterhose:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="16499ebb-3208-ec27-2def-481881728f47" name="CONF_os_USHIRT" /></p>
        </div>
    </div>
	
	 	<div class="row section">
    <p><label for="base" class="label control-label"><i class="dashicons dashicons-groups" style="font-size:20px"></i><?php echo esc_html__( '  Standard Unterhemd:', 'oswp-createavatar' ) ; ?></b></label></p>
        <div class="row">
            <p><input class="input border" type="text" value="4ac2e9c7-3671-d229-316a-67717730841d" name="CONF_os_UPANTS"/></p>
        </div>
    </div>
